...
const (
	// EssAccountPrefix is a prefix for Ess key pairs derivation.
	EssAccountPrefix = "m/44'/148'"
	// EssPrimaryAccountPath is a derivation path of the primary account.
	EssPrimaryAccountPath = "m/44'/148'/0'"
	// EssAccountPathFormat is a path format used for Ess key pair
	// derivation as described in SEP-00XX. Use with `fmt.Sprintf` and `DeriveForPath`.
	EssAccountPathFormat = "m/44'/148'/%d'"
