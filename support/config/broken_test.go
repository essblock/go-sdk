...
func TestOptionalEssFields(t *testing.T) {
	var val struct {
		F1 string `valid:"ess_accountid,optional"`
		F2 string `valid:"optional,ess_accountid"`
		F3 string `valid:"ess_seed,optional"`
		F4 string `valid:"optional,ess_accountid"`
	}
