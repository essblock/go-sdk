...
import (
	...
	"github.com/essblock/go-sdk/amount"
	"github.com/essblock/go-sdk/strkey"
...
func init() {
	...
	govalidator.CustomTypeTagMap.Set("ess_accountid", govalidator.CustomTypeValidator(isEssAccountID))
	govalidator.CustomTypeTagMap.Set("ess_seed", govalidator.CustomTypeValidator(isEssSeed))
	govalidator.CustomTypeTagMap.Set("ess_amount", govalidator.CustomTypeValidator(isEssAmount))

}

func isEssAmount(i interface{}, context interface{}) bool {
	enc, ok := i.(string)
...
func isEssAccountID(i interface{}, context interface{}) bool {
	enc, ok := i.(string)
...
func isEssSeed(i interface{}, context interface{}) bool {
	enc, ok := i.(string)
