// Package federation provides a pluggable handler that satisfies the Ess
...
import (
	...
	"github.com/essblock/go-sdk/support/db"
)
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided ess address.
...
// conform to the Ess federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// ess account id to lookup, such as
