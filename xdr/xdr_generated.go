          ...
          //
          //  ./xdr/Ess-SCP.x
//  ./xdr/Ess-ledger-entries.x
//  ./xdr/Ess-ledger.x
//  ./xdr/Ess-overlay.x
//  ./xdr/Ess-transaction.x
//  ./xdr/Ess-types.x
          //
...
// EssValueExt is an XDR NestedUnion defines as:
//
//   union switch (int v)
//        {
//        case 0:
...
//        }
//
type EssValueExt struct{
  V int32
}

// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u EssValueExt) SwitchFieldName() string {
  return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of EssValueExt
func (u EssValueExt) ArmForSwitch(sw int32) (string, bool) {
switch int32(sw) {
    case 0:
      return "", true
}
...
// NewEssValueExt creates a new  EssValueExt.
func NewEssValueExt(v int32, value interface{}) (result EssValueExt, err error) {
  result.V = v
switch int32(v) {
    case 0:
      // void
...
// EssValue is an XDR Struct defines as:
//
//   struct EssValue
//    {
...
//        EssValue scpValue;   // what consensus agreed to
...
// EssMessage is an XDR Union defines as:
//
//   union EssMessage switch (MessageType type)
//    {
//    case ERROR_MSG:
//        Error error;
//    case HELLO:
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u EssMessage) SwitchFieldName() string {
  return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of EssMessage
func (u EssMessage) ArmForSwitch(sw int32) (string, bool) {
...
// NewEssMessage creates a new  EssMessage.
func NewEssMessage(aType MessageType, value interface{}) (result EssMessage, err error) {
  result.Type = aType
...
// panicing if the value is not set.
func (u EssMessage) MustError() Error {
  val, ok := u.GetError()
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetError() (result Error, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustHello() Hello {
  val, ok := u.GetHello()
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetHello() (result Hello, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustAuth() Auth {
  val, ok := u.GetAuth()
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetAuth() (result Auth, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustDontHave() DontHave {
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetDontHave() (result DontHave, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustPeers() []PeerAddress {
  val, ok := u.GetPeers()
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetPeers() (result []PeerAddress, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustTxSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetTxSetHash() (result Uint256, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustTxSet() TransactionSet {
  val, ok := u.GetTxSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetTxSet() (result TransactionSet, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustTransaction() TransactionEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetTransaction() (result TransactionEnvelope, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustQSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetQSetHash() (result Uint256, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustQSet() ScpQuorumSet {
  val, ok := u.GetQSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetQSet() (result ScpQuorumSet, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustEnvelope() ScpEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetEnvelope() (result ScpEnvelope, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u EssMessage) MustGetScpLedgerSeq() Uint32 {
...
// returning ok if the union's switch indicated the value is valid.
func (u EssMessage) GetGetScpLedgerSeq() (result Uint32, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
